...
![](../assets/images/2025-08-23-nyx-Walkthrough/626b2c5f-5a2e-4f85-980d-6ccdc285bf86.png)

主页只有一个logo，源代码注释中的话暂时没明白是何用意

![](../assets/images/2025-08-23-nyx-Walkthrough/6b525ab2-7815-43f2-a348-564d1a5e1ee3.png)
...
![](../assets/images/2025-08-23-nyx-Walkthrough/70c3ec90-c751-44e1-98ef-8a9326bfd207.png)

`rockyou.txt`爆破无果

![](../assets/images/2025-08-23-nyx-Walkthrough/98b27dcc-3fe4-4a26-a220-8e54474fba68.png)
...
![](../assets/images/2025-08-23-nyx-Walkthrough/ca7e2d36-dae5-4859-8be3-3312fdac8e65.png)
...
![](../assets/images/2025-08-23-nyx-Walkthrough/9484b7cb-eb2a-4bb3-a4e7-91521111bef0.png)

保存私钥，将文件权限降低尝试登录（ssh不允许在私钥文件权限过于宽松的情况下登录）

![](../assets/images/2025-08-23-nyx-Walkthrough/1b2e6791-ed6a-4b21-80fb-beb4c0e1f12f.png)

# shell as root by gcc privileges

手动收集一些环境信息，发现可以`sudo`免密使用`gcc`，那么直接`gcc`提权即可

![](../assets/images/2025-08-23-nyx-Walkthrough/0ffbff04-3d3a-43bb-9e98-f35377fe9eee.png)
